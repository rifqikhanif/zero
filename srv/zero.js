...
var num = "17155448800@s.whatsapp.net"
var ownerNumber = ["17155448800@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
...
sendButLocation(from, menu, "©Created By Ikky", fakeimg, but, zer)
break
case 'downloadmenu':
menu = `❏ 「 \`\`\`DOWNLOAD MENU\`\`\` 」
...
zero.sendMessage(from, anu, image, {quoted: ftrol, caption: 'Ok Done ' })
break
case 'hartatahta':
case 'naruto':
case 'bneon':
...
zero.sendMessage(from, res, image, {quoted: ftrol, caption: 'Ok Done ' })
break
case 'wolflogo':
case 'pubglogo':
case 'snowwrite':
...
zero.sendMessage(from, wll, image, {quoted: ftrol, caption: 'Ok Done ' })
break
case 'blackpink':
case 'neon':
case 'greenneon':
...
zero.sendMessage(from, blck, image, {quoted: ftrol, caption: 'Ok Done ' })
break
case 'ssweb':
...
zero.sendMessage(from, hasil, image, { thumbnail: Buffer.alloc(0), caption: `Ok Done `, quoted : ftrol})
})
break
case 'asupan':
